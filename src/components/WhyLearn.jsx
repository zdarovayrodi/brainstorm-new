            ...
            <ul className="space-y-6 md:space-y-12 text-left mt-10">
              <li className="flex flex-row space-x-3 items-start max-w-lg">
                ...
                <div className="flex flex-col">
                  <h6 className="mt-[-5px]">
                    Играйте в любую игру с носителем
                  </h6>
                  <p className="mt-2 text-gray-500 dark:text-gray-300">
                    Наслаждайтесь игрой, общайтесь с носителем английского
                    языка, погружаясь в языковую среду и улучшая свои навыки
                  </p>
                </div>
              </li>
              <li className="flex flex-row space-x-3 items-start max-w-lg">
              ...
              <li className="flex flex-row space-x-3 items-start max-w-lg">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="mt-2 text-gray-500 dark:text-gray-300">
                    На английском языке, развивая логическое и творческое
                    мышление
                  </p>
                </div>
              </li>
              <li className="flex flex-row space-x-3 items-start max-w-lg">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="mt-2 text-gray-500 dark:text-gray-300">
                    Общайтесь с преподавателем 24/7, практикуя навыки
                    современного онлайн-общения
                  </p>
                </div>
              </li>
              <li className="flex flex-row space-x-3 items-start max-w-lg">
            ...
            <ul className="space-y-6 md:space-y-12 text-left mt-10">
              ...
              <li className="flex flex-row space-x-3 items-start max-w-lg">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="mt-2 text-gray-500 dark:text-gray-300">
                    Знание английского языка открывает множество возможностей
