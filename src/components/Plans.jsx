            ...
            <div className="max-w-[1240px] lg:w-1/2 xl:w-5/12 px-4">
                <div className="mt-10 lg:mt-0">
                    ...
                    <p className="mb-8 text-base">
                        Приобретайте наборы занятий! Рекомендуем для полноценного обучения
                        и наибольшей выгоды
                    </p>
                </div>
            </div>
  ...
  <>
    <div className="overflow-hidden bg-blue-100 dark:bg-gray-700 rounded-lg min-w-[280px] w-[280px] py-4">
      <div className="text-left px-4">
        <div className={BestValue ? 'inline rounded bg-red-600 dark:bg-red-500 px-2 py-1 mb-4' : 'hidden'}>
            <span className='text-white font-semibold'>самый выгодный</span>
        </div>
        <h3
            className={BestValue ? "my-4 block text-xl font-semibold sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px]" 
